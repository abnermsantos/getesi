...
//Método preenche campos Cliente
        public bool preencheCamposCliente(int id)
        {
...
//Método Inserir Cliente
        ...
        {
            String sql = "INSERT INTO cliente (nome, cnpj, ie, contato, telefone, email, site, rua, numero, bairro, cep, cidade, uf) VALUES('" + nome + "', '" + cnpj.ToString().Replace(",", ".") + "', '" + ie.ToString().Replace(",", ".") + "', '" + contato + "', '" + telefone + "', '" + email + "', '" + site + "', '" + rua + "', " + numero + ", '" + bairro + "', '" + cep.ToString().Replace(",", ".") + "', '" + cidade + "', '" + uf + "' )";
            return DAO.ConexaoPG.getInstancia().persistir(sql);
        }

//Método Atualizar Cliente
        public bool atualizarCliente(int id)
        {
            bool resposta;
            string sql = " update cliente set nome = '" + nome + "', cnpj = '" + cnpj.ToString().Replace(",", ".") + "', ie = '" + ie.ToString().Replace(",", ".") + "', contato = '" + contato + "', telefone = '" + telefone + "', email = '" + email + "', site = '" + site + "', rua = '" + rua + "', numero = " + numero + ", bairro = '" + bairro + "', cep = '" + cep.ToString().Replace(",", ".") + "', cidade = '" + cidade + "', uf = '" + uf + "' where codigo = " + id;
